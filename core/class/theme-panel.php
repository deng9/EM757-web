    ...
    class Wgl_Theme_Panel{
        ...
        */
        ...
        public function theme_panel_admin_menu(){
            add_menu_page (
                esc_html__('WebGeniusLab', 'foodmood'),
                esc_html__('WebGeniusLab', 'foodmood'), 
            ...
            $submenu = array();
            $submenu[] = array(
                esc_html__('Welcome', 'foodmood'),    //page_title
                esc_html__('Welcome', 'foodmood'),    //menu_title
                'manage_options',                               //capability
            ...
            if (current_user_can( 'activate_plugins' )):
                $submenu[] = array(
                    esc_html__('Theme Plugins', 'foodmood'),   //page_title
                    esc_html__('Theme Plugins', 'foodmood'),   //menu_title
            ...
            $submenu[] = array(
                esc_html__('Requirements', 'foodmood'),   //page_title
                esc_html__('Requirements', 'foodmood'),   //menu_title
                'edit_posts',                          //capability
            ...
            $submenu[] = array(
                esc_html__('Activate Theme', 'foodmood'),   //page_title
                esc_html__('Activate Theme', 'foodmood'),   //menu_title
                'edit_posts',                           //capability
            ...
            $submenu[] = array(
                esc_html__('Help Center', 'foodmood'),   //page_title
                esc_html__('Help Center', 'foodmood'),   //menu_title
                'edit_posts',                           //capability
            ...
            if ( class_exists( 'Foodmood_Core' ) ) {
                $submenu[] = array(
                    esc_html__('Theme Options', 'foodmood'),   //page_title
                    esc_html__('Theme Options', 'foodmood'),   //menu_title
                    'edit_posts',                           //capability
