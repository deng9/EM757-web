...
if ( !(bool)$wgl_blog_atts ) {
    $opt_likes = Foodmood_Theme_Helper::get_option('blog_list_likes');
    $opt_share = Foodmood_Theme_Helper::get_option('blog_list_share');
    $opt_meta = Foodmood_Theme_Helper::get_option('blog_list_meta');
    $opt_meta_author = Foodmood_Theme_Helper::get_option('blog_list_meta_author');
    $opt_meta_comments = Foodmood_Theme_Helper::get_option('blog_list_meta_comments');
    $opt_meta_categories = Foodmood_Theme_Helper::get_option('blog_list_meta_categories');
    $opt_meta_date = Foodmood_Theme_Helper::get_option('blog_list_meta_date');
    $opt_read_more = Foodmood_Theme_Helper::get_option('blog_list_read_more');
    $opt_hide_media = Foodmood_Theme_Helper::get_option('blog_list_hide_media');
    $opt_hide_title = Foodmood_Theme_Helper::get_option('blog_list_hide_title');
    $opt_hide_content = Foodmood_Theme_Helper::get_option('blog_list_hide_content');
    $opt_letter_count = Foodmood_Theme_Helper::get_option('blog_list_letter_count');
    $opt_blog_columns = Foodmood_Theme_Helper::get_option('blog_list_columns');
...
while ($query->have_posts()) : $query->the_post();          
    ...
    <div class="blog-post <?php echo esc_attr($blog_item_classes); ?>"<?php echo Foodmood_Theme_Helper::render_html($blog_attr);?>>
