<?php
	...
	$single_date =  Foodmood_Theme_Helper::get_option('single_meta_date');
	...
	$page_title_padding = Foodmood_Theme_Helper::options_compare('single_padding_layout_3', 'mb_post_layout_conditional', 'custom');
	...
	$apply_animation = Foodmood_Theme_Helper::options_compare('single_apply_animation', 'mb_post_layout_conditional', 'custom');
		...
		<div class="item_wrapper">
			<div class="blog-post_content" >
				<?php
					...
					if ( !(bool)$single_meta && !empty($meta_args_date) ) {
						$single->render_post_meta($meta_args_date);
					}   
				?>
